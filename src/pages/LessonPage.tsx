...
const ProgressChip = memo(function ProgressChip({
  scrollYProgress,
  accent,
}: {
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: `0 4px 14px -4px ${accent}20, 0 2px 6px rgba(0,0,0,0.4)`,
...
interface FloatingLessonNavProps {
  moduleTitle: string;
  moduleSlug: string;
  accent: string;
  scrollYProgress: MotionValue<number>;
...
const FloatingLessonNav = memo(function FloatingLessonNav({
  moduleTitle,
  moduleSlug,
  accent,
  scrollYProgress,
}: FloatingLessonNavProps) {
  return (
    <nav
        ...
        <div className="pointer-events-auto min-w-0 flex-shrink">
          <Link
            ...
            style={{
              ...
              backdropFilter: "blur(12px)",
              WebkitBackdropFilter: "blur(12px)",
              boxShadow: `0 4px 16px -4px ${accent}25, 0 2px 6px rgba(0,0,0,0.4)`,
            }}
          >
            <ArrowLeft
...
export default function LessonPage() {
  ...
  return (
    <div className="relative z-10 w-full overflow-x-clip min-h-screen">
      {/* Zero-overhead hairline reading progress bar at top edge */}
      <motion.div
        aria-hidden
        className="fixed top-0 inset-x-0 h-[2px] z-50 origin-left pointer-events-none transform-gpu"
        style={{
      ...
      <div className="relative mx-auto w-full max-w-[45rem] px-3.5 sm:px-6 pb-28 pt-2 sm:pt-4">
        ...
        {/* Compact floating chip-based navigation */}
        <FloatingLessonNav
      ...
      {!nextLesson && (
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="relative mt-12 overflow-hidden rounded-3xl border border-emerald-500/35 bg-gradient-to-br from-[#0c1815] via-[#0b101c] to-[#080512] p-6 shadow-2xl sm:p-8"
          style={{
            boxShadow:
